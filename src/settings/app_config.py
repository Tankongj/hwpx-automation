...
class AppConfig:
    ...
    # v0.16.0: Firebase App Hosting manifest 기반 자동 업데이트.
    # TODO: Firebase 프로젝트 생성 후 실제 URL 로 교체 (예: https://hwpx-automation.web.app/api/manifest.json)
    update_manifest_url: str = ""  # 빈 문자열이면 업데이트 체크 건너뜀 (개발 중 / 미설정 상태)
